"""
src/core/agent.py - OPTIMUS's Agentic AI layer: Brain (LLM) + Tools + Memory + Planning &
...
You are Optimus operating in AGENTIC mode - you can call tools to take real action,
...
Action: none
Action Input: {{}}
Final Answer: <your in-character Optimus reply to the user, confirming what was done>
...
def run_agent(query, short_term: ShortTermMemory, verbose=True):
    ...
    return "Sir, I've hit my planning limit for this request - let's try rephrasing it, or breaking it into smaller steps.", trace
