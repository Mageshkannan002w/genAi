...
OPTIMUS's knowledge base: Ingestion & Chunking -> Embeddings -> Vector DB & Indexing.
...
def main():
    print("Step 1/2 - Ingestion & Chunking (one strategy per OPTIMUS knowledge type):")
    ...
    print("\nOPTIMUS's knowledge base is ready. Run: streamlit run app/streamlit_app.py")
