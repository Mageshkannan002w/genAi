...
| `What's Tony's favorite color?` | **Should say it doesn't know** - this isn't in the knowledge base. Confirms OPTIMUS isn't hallucinating past the retrieved context. |

## Agentic Mode

In the Streamlit UI, open the "See OPTIMUS's reasoning" expander under each reply to
